    ...
    try {
      ...
      if (data.success) {
        ...
        setForm({
          ...
          isOriginal: preset.isOriginal ?? true,
          enableReward: preset.enableReward ?? false,
          autoSelectCover: preset.autoSelectCover ?? true,
          autoGenerateDigest: preset.autoGenerateDigest ?? true,
          enableFeaturedArticles: preset.enableFeaturedArticles ?? false,
          customContent: preset.customContent || '',
          recommendedAccount: preset.recommendedAccount || '',
