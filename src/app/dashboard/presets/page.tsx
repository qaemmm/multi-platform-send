...
import { Plus, Settings, Star, Trash2, Edit, ArrowLeft } from 'lucide-react';
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        <span className="text-gray-500">自动摘要：</span>
                        <span className="text-gray-900">{preset.autoGenerateDigest ? '是' : '否'}</span>
                      </div>
                      <div>
                        <span className="text-gray-500">精选文章：</span>
                        <span className="text-gray-900">{preset.enableFeaturedArticles ? '启用' : '关闭'}</span>
                      </div>
                      <div>
                        <span className="text-gray-500">定制内容：</span>
                        <span className="text-gray-900">{preset.customContent ? '已设置' : '未设置'}</span>
                      </div>
                    </div>

                    {preset.recommendedAccount && (
                      <div className="mt-3 text-sm">
                        <span className="text-gray-500">推荐公众号：</span>
                        <span className="text-gray-900">{preset.recommendedAccount}</span>
                      </div>
                    )}
                  </div>
